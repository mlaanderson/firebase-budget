...
class BudgetForm extends renderer_1.default {
    constructor() {
        ...
        $(() => {
            ...
            this.periodMenu = new button_1.default('#periodMenu').on('click', this.periodMenu_onClick.bind(this));
    ...
    periodMenu_onClick(e) {
        return __awaiter(this, void 0, void 0, function* () {
            e.preventDefault();
            new calenderdialog_1.default(Date.parseFb(this.periodStart), (d) => this.budget.gotoDate(d), {
                select: 'period',
